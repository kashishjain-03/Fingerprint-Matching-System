...
if __name__ == "__main__":
    ...
    image_path1="/Users/kashishjain/Desktop/Sem-II/Biometric Sec - SIL775/Assignments/A1_Biometric/Fingerprint-Verification-System-main/testcases/DB1_B/104_1.tif"
    image_one = cv.imread(image_path1 ,cv.IMREAD_GRAYSCALE )
    #interactive_display("Fingerprint 1",image_one)
    image_path2=image_path1="/Users/kashishjain/Desktop/Sem-II/Biometric Sec - SIL775/Assignments/A1_Biometric/Fingerprint-Verification-System-main/testcases/DB1_B/104_2.tif"
    ...
    interactive_display("Fingerprint 2 Thinning",thinned_image_one)
    interactive_display("Fingerprint 2- Minutae",thinned_image_two)
    ...
    print("Number of Minutae matched",match)
